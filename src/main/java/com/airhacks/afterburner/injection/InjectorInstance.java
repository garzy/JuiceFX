...
import com.airhacks.afterburner.injection.modules.InjectorInstanceModule;
...
public class InjectorInstance {
    ...
    private final Set<Object> presenters = Collections.newSetFromMap(new WeakHashMap<>());

    private Function<Class<?>, Object> instanceSupplier = getDefaultInstanceSupplier();
    ...
    public void setInstanceSupplier(Function<Class<?>, Object> instanceSupplier) {
        this.instanceSupplier = instanceSupplier;
    }

    public void setConfigurationSource(Function<Object, Object> configurationSupplier) {
        configurator.set(configurationSupplier);
    }

    public void resetInstanceSupplier() {
     ...
     */
    public <T> T registerExistingAndInject(T instance) {
    ...
    private void doCallAnotationMethodsOnFieldsInstance(Object instance,
            final Class<? extends Annotation> annotationClass) {
    ...
    public com.google.inject.Injector getGuiceInjector() {
        if (guiceInjector == null) {
            ...
            modules.add(new InjectorInstanceModule(this));
            guiceInjector = Guice.createInjector(modules);
        }
        return guiceInjector;
    }

    public void setGuiceModules(Module... modules) {
        guiceModules.clear();
     ...
     */
    public void setGuiceInjector(com.google.inject.Injector injector) {
        List<Module> modules = new ArrayList<>(guiceModules);
        modules.add(new JuiceFXModule(configurator));
        modules.add(new InjectorInstanceModule(this));
    ...
    public Consumer<String> getDefaultLogger() {
        return l -> {
        };
    }
}
